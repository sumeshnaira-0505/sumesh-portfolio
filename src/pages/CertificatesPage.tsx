...
const CERTIFICATES: Certificate[] = [
  // ── Technical ──────────────────────────────────────────────────────
  {
    ...
    date: 'Feb 2026',
    category: 'Technical',
    file: '/certificates/Postman API Fundamentals Student Expert - 2026-02-07.pdf',
    type: 'pdf',
    color: '#f97316',
  },
  {
    ...
    date: '2022',
    category: 'Technical',
    file: '/certificates/Legacy Responsive Web Design V8 Certification.png',
    type: 'image',
    color: '#a855f7',
  },
  // ── Analytics & Marketing ──────────────────────────────────────────
  {
    ...
    file: '/certificates/Google Analytics Certification.pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  {
    ...
    date: '2024',
    category: 'Analytics & Marketing',
    file: '/certificates/Get Started using Google Analytics (GA4).pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  {
    ...
    date: '2024',
    category: 'Analytics & Marketing',
    file: '/certificates/Dive Deeper into GA4 Data and Reports.pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  {
    ...
    date: '2024',
    category: 'Analytics & Marketing',
    file: '/certificates/DigitalMarketingFundamentals-SumeshNairA-1145438.pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  {
    ...
    date: '2024',
    category: 'Analytics & Marketing',
    file: '/certificates/MarketingStrategyFundamentals-SumeshNairA-1145331 (1).pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  {
    ...
    date: '2024',
    category: 'Analytics & Marketing',
    file: '/certificates/MarketingResearchFundamentals-SumeshNairA-1145507.pdf',
    type: 'pdf',
    color: '#f59e0b',
  },
  // ── Agile & Project Management ─────────────────────────────────────
  {
    ...
    date: '2024',
    category: 'Agile & PM',
    file: '/certificates/KanbanEssentialswithAICertified-SumeshNairA-1144991.pdf',
    type: 'pdf',
    color: '#22c55e',
  },
  {
    ...
    date: '2024',
    category: 'Agile & PM',
    file: '/certificates/ScrumFundamentalsCertified-SumeshNairA-1144801.pdf',
    type: 'pdf',
    color: '#22c55e',
  },
  {
    ...
    date: '2024',
    category: 'Agile & PM',
    file: '/certificates/OKRFundamentalswithAICertified-SumeshNairA-1145193.pdf',
    type: 'pdf',
    color: '#22c55e',
  },
  // ── Business Skills ────────────────────────────────────────────────
  {
    ...
    file: '/certificates/SixSigmaYellowBelt-SumeshNairA-1144981.pdf',
    type: 'pdf',
    color: '#3b82f6',
  },
  {
    ...
    date: '2024',
    category: 'Business Skills',
    file: '/certificates/BusinessAnalysisFundamentalswithAICertified-SumeshNairA-1145188.pdf',
    type: 'pdf',
    color: '#3b82f6',
  },
  {
    ...
    date: '2024',
    category: 'Business Skills',
    file: '/certificates/CorporateSalesFundamentals-SumeshNairA-1145511.pdf',
    type: 'pdf',
    color: '#3b82f6',
  },
  {
    ...
    date: '2024',
    category: 'Business Skills',
    file: '/certificates/NegotiationAssociate-SumeshNairA-1145741.pdf',
    type: 'pdf',
    color: '#3b82f6',
  },
]
